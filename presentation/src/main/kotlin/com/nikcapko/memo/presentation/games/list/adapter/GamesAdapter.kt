package com.nikcapko.memo.presentation.games.list.adapter

import android.view.LayoutInflater
import android.view.ViewGroup
import androidx.recyclerview.widget.RecyclerView
import com.nikcapko.domain.model.Game
import com.nikcapko.memo.core.ui.BaseItemViewHolder
import com.nikcapko.memo.presentation.databinding.ItemGameListBinding
import com.nikcapko.memo.presentation.games.list.GamesCommand
import kotlin.properties.Delegates

internal class GamesAdapter(
    private val commandProcessor: (GamesCommand) -> Unit,
    ...
    inner class ItemViewHolder(itemBinding: ItemGameListBinding) :
        ...
        init {
            itemView.setOnClickListener {
                commandProcessor(GamesCommand.ItemClickCommand(absoluteAdapterPosition))
            }
        }
