...
internal class FindPairsFragment : BaseFragment(), FindPairsEventController {
    ...
    private fun setListeners() = with(viewBinding) {
        rgWord.setOnCheckedChangeListener { group, checkedId ->
            if (rgTranslate.checkedRadioButtonId != -1 && checkedId != -1) {
                ...
                viewModel.processCommand(
                    command = com.nikcapko.memo.presentation.games.findpairs.FindPairsCommand.FindPairCommand(
        ...
        btnExit.setOnClickListener {
            viewModel.processCommand(com.nikcapko.memo.presentation.games.findpairs.FindPairsCommand.BackPressedCommand)
        }
    ...
    private fun onRetry() {
        viewModel.processCommand(com.nikcapko.memo.presentation.games.findpairs.FindPairsCommand.LoadWordsCommand)
    }
}
