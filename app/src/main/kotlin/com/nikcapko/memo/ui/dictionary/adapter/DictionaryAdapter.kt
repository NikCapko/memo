package com.nikcapko.memo.ui.dictionary.adapter
...
import com.nikcapko.memo.databinding.ItemDictionaryListBinding
import kotlin.properties.Delegates

class DictionaryAdapter(val onItemClick: (Int) -> Unit) : RecyclerView.Adapter<BaseItemViewHolder<ItemDictionaryListBinding, Dictionary>>() {
